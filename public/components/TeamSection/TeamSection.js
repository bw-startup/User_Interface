...
const data = [
  {name: "Audrey Akwenye", email: "pending@gmail.com", github: "https://github.com/", role: "Team Leader", profile_pic: "https://ca.slack-edge.com/T4JUEB3ME-UDRCZPDV5-4830c84686b2-512", bio: "I’m an educator, entrepreneur and data scientist.", linkedin:"", twitter:""},
  {name: "Andy Bettisworth", email: "andy@accreu.com", github: "https://github.com/wurde", role: "User Interface", profile_pic: "https://ca.slack-edge.com/T4JUEB3ME-UGBNBF0SV-56a86324406c-512", bio: "Lambda Student in the Full Stack WEB19 cohort. A freelance web developer for almost a decade. Based out of Texas. Self-motivated lifelong learner. Open to new ideas and connections. He is either coding or training for a triathlon.", linkedin:"https://www.linkedin.com/in/bettisworth/", twitter:"https://twitter.com/AndyBettisworth"},
...
const colorSet = [["Team Leader","bg-chathams-blue"], ["User Interface", "bg-matisse"], ["Backend Engineer", "bg-jewel"], ["Frontend Engineer", "bg-eucalyptus"], ["Data Scientist", "bg-green-pea"]];
